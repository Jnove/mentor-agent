...
NOTES = [
    ...
    # ---- 8 个学院批量接入（2026-08）----
    ("math-gzzd", "研究生", "研究生政策（助教管理/学籍实施办法/教学管理）；math 站点偶发连接重置，需复核完整性。"),
    ("math-xjgl", "主修专业确认工作细则", "最新细则，valid: true；配套的拟录取名单公示判 valid: false。"),
    ("math-xjgl", "名单公示", "时效性名单，valid: false。"),
    ("css-wjhb", "部发（25）", "理学部文件（研究生学位申请细则/助学金名单/导师资格通知）；名单类判 valid: false。"),
    ("css-wjhb", "获奖名单|助学金获得者|导师资格", "时效性名单，valid: false 或重分类。"),
    ("sis-xjgl", "", "学籍/教学通知多为历史（2012-2018 年），大部分判 valid: false；仅保留仍在用的。"),
    ("gs-tz", "教职工大会", "行政通知（对学生的学长组价值低），valid 评估或剔除。"),
    ("physics-tz", "Nature|Science|PNAS", "科研发表新闻，非学生政策，价值低；重分类或 valid: false。"),
    ("som-xxgg", "退学|学位授权点", "退学决定/年度报告，价值低；valid 评估。"),
    ("psych-bks", "科研成果展", "展示类内容，价值中等；valid 评估。"),
    ("chem-gzzd", "", "化学系党委文件（党建制度/三重一大/捐赠激励）；对本科生价值中等，valid 评估。"),
]
