...
用法:
    ...
    python scripts/import_teachers.py --force          # 全量重建
    python scripts/import_teachers.py --no-llm         # 跳过混合记录 LLM 聚类趟
"""
import argparse
import csv
import glob
...
DEFAULT_SRC = "C:/Users/Jnove/Downloads/extracted"

# 高赞分歧阈值（候选规则 C）
DIVERGENT_NET = 15   # |净赞| 达到此值算"高赞"
...
def main() -> None:
    ...
    ap.add_argument("--src", default=DEFAULT_SRC, help="数据目录（默认 extracted）")
