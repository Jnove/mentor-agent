...
2026-8-17修：这题属于枚举类问题，RAG确实不擅长，另外我们其实是混合RAG检索的，以下是同问题最新项目的表现：![](image/ISSUES/update_2.png)有一个错误是误将强基混入2026新增的了。
...
2026-8-13修：感觉这个是偶发错误，新版测试如下：![](image/ISSUES/update_1.png)